...
- `chunk_review.html`：直接从正式 `all_chunks.jsonl` 生成，统一提供法规筛选、法规目录和 1,228 个 Chunk 的正文查看。
...
- Chunk 字数显示、正文复制和折叠展开
- Chunk 正文、章节和条款范围

公开页面不包含本机绝对路径、`source_block_ids`、overlap 来源、自动风险启发式等构建过程信息。
